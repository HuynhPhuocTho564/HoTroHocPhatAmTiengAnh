...
import { apiFailure, apiSuccess, readJsonObject, readNullableString, readOptionalStatus, readRequiredString, requireAdminSession } from "@/lib/admin-api";

const STATUSES = ["DRAFT", "NEEDS_REVIEW", "ACTIVE", "ARCHIVED"] as const;
...
export async function PATCH(request: NextRequest, context: RouteContext) {
  try {
    ...
    const status = readOptionalStatus(body.status, STATUSES);
