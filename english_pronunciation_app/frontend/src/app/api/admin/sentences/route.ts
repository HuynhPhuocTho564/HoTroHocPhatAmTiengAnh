...
import { apiFailure, apiSuccess, readJsonObject, readOptionalString, readRequiredString, readStatus, requireAdminSession } from "@/lib/admin-api";
...
export async function POST(request: NextRequest) {
  try {
    ...
    const status = readStatus(body.status, STATUSES, "NEEDS_REVIEW");
