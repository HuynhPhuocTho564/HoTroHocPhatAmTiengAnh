      ...
      <main className="max-w-6xl mx-auto">
        ...
        <div className="mb-10">
          ...
          <p className="text-lg text-neutral-600">
            Chọn bài tập để luyện nghe, nói từ, minimal pair và câu ngắn. Kết quả sẽ được lưu vào XP, badge và bảng xếp hạng.
          </p>
        </div>
        ...
        {exercises.length === 0 ? (
          <Card>
            <p className="text-neutral-600">
              Chưa có bài tập trong database. Hãy chạy seed data trước khi demo luồng làm bài.
            </p>
          </Card>
        ) : (
                ...
                <Card key={exercise.id} className={isActive ? "" : "opacity-80"}>
                  ...
                  {isActive ? (
                    <Link
                      ...
                      className="inline-flex w-full justify-center rounded-lg bg-neutral-900 px-4 py-3 text-sm font-bold text-white hover:bg-neutral-800 transition-colors"
                    >
                      Bắt đầu làm bài
                    </Link>
                  ) : (
