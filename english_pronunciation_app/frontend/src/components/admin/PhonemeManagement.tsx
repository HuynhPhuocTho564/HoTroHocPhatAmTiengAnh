  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-xl font-bold text-neutral-900">Quản lý Phoneme</h2>
          <p className="mt-1 text-sm text-neutral-600">{phonemes.length} phoneme trong hệ thống</p>
        </div>
      ...
      {error && (
        <Card>
          <div className="border-l-4 border-error-500 bg-error-50 p-4">
          ...
          <table className="w-full text-left text-sm">
            ...
            <tbody>
              {phonemes.map((phoneme) => (
                <tr key={phoneme.id} className="border-b border-neutral-100 hover:bg-neutral-50">
                  ...
                  <td className="px-4 py-3">
                    <div className="flex gap-2">
                      ...
                      <button
                        ...
                        className="text-sm font-semibold text-error-600 hover:underline"
                      >
                        Xóa
                      </button>
                    </div>
