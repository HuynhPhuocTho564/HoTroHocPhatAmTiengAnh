...
export const SPIN_WHEEL_PRIZES: SpinPrize[] = [
  { id: "gems_10", label: "10 💎", weight: 25, value: { gems: 10 }, angle: 0 },
  { id: "xp_100", label: "100 XP", weight: 20, value: { xp: 100 }, angle: 45 },
  { id: "gems_5", label: "5 💎", weight: 15, value: { gems: 5 }, angle: 90 },
  { id: "streak_freeze", label: "Bùa Đóng Băng", weight: 15, value: { streakFreezes: 1 }, angle: 135 },
  { id: "gems_20", label: "20 💎", weight: 10, value: { gems: 20 }, angle: 180 },
  { id: "gems_50", label: "50 💎", weight: 10, value: { gems: 50 }, angle: 225 },
  { id: "nothing", label: "Hên xui!", weight: 4, value: {}, angle: 270 },
  { id: "jackpot", label: "JACKPOT 100💎", weight: 1, value: { gems: 100 }, angle: 315 },
];
