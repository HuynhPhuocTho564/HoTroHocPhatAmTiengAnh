...
│   ├── seed_demo_data.ts             ← ⭐ Tạo 7 learner + gamification data
...
### Đã tạo (untracked)
```
?? english_pronunciation_app/frontend/prisma/seed_demo_data.ts        ← 7 learner + gamification data
...
|---|---|---|---|
| `demo@pronunciation.app` | `demo123456` | Admin | Truy cập /admin |
| `duc@demo.app` | `demo123456` | User | XP 4100, level 5 |
| `hoang@demo.app` | `demo123456` | User | XP 3200, level 4 |
| `minh@demo.app` | `demo123456` | User | XP 2450, level 3 |
| `lan@demo.app` | `demo123456` | User | XP 1820, level 2 |
| `mai@demo.app` | `demo123456` | User | XP 980, level 2 |
| `anh@demo.app` | `demo123456` | User | XP 560, level 1 |
...
npx tsx prisma/seed_demo_data.ts      # Tạo 7 learner + gamification data
```
...
- **db_cleanup**: TRUNCATE tất cả → mất demo users → re-seed `seed_demo_user` + `seed_demo_data`
- **Demo login**: `demo@pronunciation.app` / `demo123456` (Admin)
